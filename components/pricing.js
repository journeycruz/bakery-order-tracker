export default function Pricing() {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-rose-gold-50">
      ...
      <div className="grid max-w-md gap-10 row-gap-5 lg:max-w-screen-lg sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-lg sm:mx-auto">
        <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded-3xl shadow-sm sm:items-center hover:shadow">
          ...
          <div>
            <a
              href="/"
              className="inline-flex items-center justify-center w-full h-12 px-6 mt-6 font-medium tracking-wide text-white transition duration-200 bg-rose-gold-700 rounded-3xl shadow-md hover:bg-rose-gold-500 focus:shadow-outline focus:outline-none"
            >
              Start for free
            </a>
        ...
        <div className="relative flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded-3xl shadow-sm sm:items-center hover:shadow border-gold-lighter">
          ...
          <div>
            <a
              href="/"
              className="inline-flex items-center justify-center w-full h-12 px-6 mt-6 font-medium tracking-wide text-white transition duration-200 rounded-3xl shadow-md bg-gold-darker hover:bg-gold-lighter focus:shadow-outline focus:outline-none"
            >
              Buy Pro
            </a>
            <p className="max-w-xs mt-6 text-xs text-gray-600 sm:text-sm sm:text-center sm:max-w-sm sm:mx-auto">
