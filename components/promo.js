        ...
        <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
            <div className="sm:max-w-lg">
              <h1 className="pb-8 md:pb-0 cormorant-sub text-left tracking-tight text-rose-gold-900 sm:text-4xl">
                Tis the season
              </h1>
              <p className="mt-4 text-xl text-gray-500">
                This year, our new holiday collection will shelter you from the harsh elements of a world that doesn't care
                if you live or die.
              </p>
            </div>
            <div>
